...
public class LoginUI extends JFrame {
        ...
        btMinhDanh.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
				...
				if (checkXacthuc(tendangnhap, email)) {
				    mailxacthuc(email, "MÃ OTP XÁC THỰC",
							"NAIM BLOSSOM HOMESTAY XIN CHÀO BẠN.\n"
							+ "Cảm ơn quý khách đã lựa chọn khách sạn của chúng tôi cho kỳ nghỉ sắp tới.\n"
							+ "Để đảm bảo an toàn, kính mong quý khách không chia sẻ mã OTP cho bất kỳ ai.\n"
							+ "Vui lòng nhập mã này vào ứng dụng để hoàn tất quá trình đặt phòng.\n"
							+ "Nếu quý khách không yêu cầu mã này, vui lòng bỏ qua email này hoặc liên hệ với đội ngũ hỗ trợ khách hàng của chúng tôi để được trợ giúp.\n"
							+ "Trân trọng,\n"
							+ "Mã OTP:"
					);
	...
	public void mailxacthuc(String email, String tieude, String noidung) {
		...
		final String user = "naimblossomhomestay@gmail.com";
		final String password = "yoxn spit emda pnfz"; // Replace with your actual password
