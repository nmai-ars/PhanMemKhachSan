...
// btHienThiTatCa.setBackground(new Color(220, 220, 220)); // Một màu trung tính
		...
		this.pn_sodophong.add(lblNewLabel_15);
		...
		this.pn_sodophong.add(lb_makhachhang);
	...
	public void sendmail(String email, String tieude, int madp, String hoten, Phong phong) {
		...
		try {
			...
			message.setText("NAIM BLOSSOM HOMESTAY.\n"+
							"XIN CHÀO "+hoten+
							"\nMã đặt phòng cho phòng "+phong.getId()+" là\n"+
							"         "+madp+
							"\nHãy dùng mã này để đăng nhập vào phòng"+
							"\nCảm ơn bạn đã sử dụng dịch vụ của chúng t" +
					"ôi\n"+
	...
	private void filterPhongTheoTrangThai(TrangThaiPhong trangThaiCanLoc) {
		...
		for (PhongManager phongManager : quanLyPhong) {
